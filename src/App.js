...
const App = () => {
  ...
  // Food orders with prices between ₦1,500 and ₦3,000
   const orders = [
  { id: 1, customerName: "Amina Yusuf", foodOrdered: "Jollof Rice & Grilled Tilapia", price: 2500, status: "Delivered", orderTime: "2026-02-01 11:20" },
  { id: 2, customerName: "Emeka Okafor", foodOrdered: "Pepper Soup & Pounded Yam", price: 1850, status: "Pending", orderTime: "2026-02-01 14:45" },
  { id: 3, customerName: "Fatima Bello", foodOrdered: "Grilled Chicken & Chips", price: 2200, status: "Delivered", orderTime: "2026-02-02 09:15" },
  { id: 4, customerName: "Oluwaseun Adebayo", foodOrdered: "Seafood Okra Soup & Eba", price: 2800, status: "Delivered", orderTime: "2026-02-02 13:40" },
  { id: 5, customerName: "Yusuf Mohammed", foodOrdered: "Assorted Meat Pepper Soup", price: 1950, status: "Pending", orderTime: "2026-02-03 17:20" }
];
  return (
