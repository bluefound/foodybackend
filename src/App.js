...
const App = () => {
  ...
  const orders = [
    ...
    // New orders for September 15-27, 2025
    { id: 66, customerName: "Oluwaseun Adebayo", foodOrdered: "Ofada Rice and Sauce", price: 3000, status: "Delivered", orderTime: "2025-09-16 09:15" },
    { id: 67, customerName: "Ibrahim Musa", foodOrdered: "Eba and Okro Soup", price: 2000, status: "Delivered", orderTime: "2025-09-16 11:30" },
    { id: 68, customerName: "Ngozi Eze", foodOrdered: "Plantain and Egg Sauce", price: 1200, status: "Out for Delivery", orderTime: "2025-09-16 13:45" },
    { id: 69, customerName: "Yusuf Bello", foodOrdered: "Pepper Soup", price: 2500, status: "Preparing", orderTime: "2025-09-16 15:20" },
    { id: 70, customerName: "Amina Suleiman", foodOrdered: "Yam Porridge", price: 1800, status: "Delivered", orderTime: "2025-09-16 17:00" },
    { id: 71, customerName: "Chinedu Okafor", foodOrdered: "Jollof Rice and Chicken", price: 2500, status: "Delivered", orderTime: "2025-09-17 10:15" },
    { id: 72, customerName: "Funke Adeleke", foodOrdered: "Fried Rice and Chicken", price: 1800, status: "Cancelled", orderTime: "2025-09-17 12:30" },
    { id: 73, customerName: "Oluwaseun Bakare", foodOrdered: "Pounded Yam and Egusi", price: 2800, status: "Delivered", orderTime: "2025-09-17 14:45" },
    { id: 74, customerName: "Ibrahim Nwosu", foodOrdered: "Amala and Ewedu", price: 2200, status: "Preparing", orderTime: "2025-09-18 09:30" },
    { id: 75, customerName: "Ngozi Chukwu", foodOrdered: "Beef Suya", price: 1500, status: "Delivered", orderTime: "2025-09-18 11:45" },
    { id: 76, customerName: "Yusuf Eze", foodOrdered: "Ofada Rice and Sauce", price: 3000, status: "Out for Delivery", orderTime: "2025-09-18 14:00" },
    { id: 77, customerName: "Amina Okafor", foodOrdered: "Eba and Okro Soup", price: 2000, status: "Delivered", orderTime: "2025-09-19 10:15" },
    { id: 78, customerName: "Chinedu Suleiman", foodOrdered: "Plantain and Egg Sauce", price: 1200, status: "Delivered", orderTime: "2025-09-19 12:30" },
    { id: 79, customerName: "Funke Nwankwo", foodOrdered: "Pepper Soup", price: 2500, status: "Cancelled", orderTime: "2025-09-19 14:45" },
    { id: 80, customerName: "Oluwaseun Hassan", foodOrdered: "Yam Porridge", price: 1800, status: "Delivered", orderTime: "2025-09-20 09:00" },
    { id: 81, customerName: "Ibrahim Okechukwu", foodOrdered: "Jollof Rice and Chicken", price: 2500, status: "Preparing", orderTime: "2025-09-20 11:15" },
    { id: 82, customerName: "Ngozi Bello", foodOrdered: "Fried Rice and Chicken", price: 1800, status: "Delivered", orderTime: "2025-09-20 13:30" },
    { id: 83, customerName: "Yusuf Okonkwo", foodOrdered: "Pounded Yam and Egusi", price: 2800, status: "Out for Delivery", orderTime: "2025-09-20 15:45" },
    { id: 84, customerName: "Amina Usman", foodOrdered: "Amala and Ewedu", price: 2200, status: "Delivered", orderTime: "2025-09-21 10:00" },
    { id: 85, customerName: "Chinedu Nwankwo", foodOrdered: "Beef Suya", price: 1500, status: "Delivered", orderTime: "2025-09-21 12:15" },
    { id: 86, customerName: "Funke Adebayo", foodOrdered: "Ofada Rice and Sauce", price: 3000, status: "Cancelled", orderTime: "2025-09-21 14:30" },
    { id: 87, customerName: "Oluwaseun Musa", foodOrdered: "Eba and Okro Soup", price: 2000, status: "Delivered", orderTime: "2025-09-22 09:45" },
    { id: 88, customerName: "Ibrahim Eze", foodOrdered: "Plantain and Egg Sauce", price: 1200, status: "Preparing", orderTime: "2025-09-22 12:00" },
    { id: 89, customerName: "Ngozi Okafor", foodOrdered: "Pepper Soup", price: 2500, status: "Delivered", orderTime: "2025-09-22 14:15" },
    { id: 90, customerName: "Yusuf Suleiman", foodOrdered: "Yam Porridge", price: 1800, status: "Out for Delivery", orderTime: "2025-09-23 10:30" },
    { id: 91, customerName: "Amina Nwankwo", foodOrdered: "Jollof Rice and Chicken", price: 2500, status: "Delivered", orderTime: "2025-09-23 12:45" },
    { id: 92, customerName: "Chinedu Hassan", foodOrdered: "Fried Rice and Chicken", price: 1800, status: "Delivered", orderTime: "2025-09-23 15:00" },
    { id: 93, customerName: "Funke Okechukwu", foodOrdered: "Pounded Yam and Egusi", price: 2800, status: "Cancelled", orderTime: "2025-09-24 11:15" },
    { id: 94, customerName: "Oluwaseun Bello", foodOrdered: "Amala and Ewedu", price: 2200, status: "Delivered", orderTime: "2025-09-24 13:30" },
    { id: 95, customerName: "Ibrahim Okonkwo", foodOrdered: "Beef Suya", price: 1500, status: "Preparing", orderTime: "2025-09-25 09:45" },
    { id: 96, customerName: "Ngozi Usman", foodOrdered: "Ofada Rice and Sauce", price: 3000, status: "Delivered", orderTime: "2025-09-25 12:00" },
    { id: 97, customerName: "Yusuf Adebayo", foodOrdered: "Eba and Okro Soup", price: 2000, status: "Out for Delivery", orderTime: "2025-09-25 14:15" },
    { id: 98, customerName: "Amina Musa", foodOrdered: "Plantain and Egg Sauce", price: 1200, status: "Delivered", orderTime: "2025-09-26 10:30" },
    { id: 99, customerName: "Chinedu Eze", foodOrdered: "Pepper Soup", price: 2500, status: "Delivered", orderTime: "2025-09-26 12:45" },
    { id: 100, customerName: "Funke Okafor", foodOrdered: "Yam Porridge", price: 1800, status: "Delivered", orderTime: "2025-09-27 09:00" }
  ];
